        ...
        >
            <div className="container mx-auto px-6 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    <button className="px-5 py-2 text-sm font-semibold bg-primary text-primary-foreground rounded-full hover:bg-primary/90 transition-colors">
                        Get in Touch
                    </button>
                </div>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden absolute top-full left-0 right-0 bg-background border-b border-border p-6 flex flex-col space-y-4 shadow-2xl">
                    ...
                    <button className="w-full px-5 py-3 text-lg font-semibold bg-primary text-primary-foreground rounded-lg">
                        Get in Touch
                    </button>
                </div>
            )}
